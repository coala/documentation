...
installed as ``virtualenv`` or ``pyvenv``. You can check if its already installed by typing:
::
...
The (--user) option will install virtualenv in your home directory, which doesn't require any special privileges.
